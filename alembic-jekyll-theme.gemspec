...
Gem::Specification.new do |spec|
  ...
  spec.version       = "3.1.0"
  spec.authors       = ["Syed Jafer"]
  spec.email         = ["ceo.daywithalgorithm.com"]

  spec.summary       = %q{Learn, Discuss, UnLearn, Relearn Algorithms.}
  spec.description   = "Learn, Discuss, UnLearn, Relearn Algorithms."
  spec.homepage      = "https://daywithalgorithm.github.io/"
  spec.license       = "MIT"
